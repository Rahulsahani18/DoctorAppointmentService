...
import { Star, MapPin, Clock, Calendar, Heart, Share2, Phone, Mail, Facebook, Twitter, Linkedin, ChevronLeft, ChevronRight } from 'lucide-react';
...
const DoctorProfile = () => {
  ...
  const doctorData = {
    ...
    services: [
      ...
      "Orthodontics", "Periodontics", "Oral Surgery", "Pediatric Dentistry"
    ],
    awards: [
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2 days ago",
        comment: "Excellent service! Dr. Elder is very professional and caring.",
        verified: true
      },
      {
        id: 2,
        ...
        rating: 4,
        date: "1 week ago",
        comment: "Great experience. The staff was friendly and the clinic was clean.",
        verified: true
      },
      {
        id: 3,
                ...
                <div className="education-section mt-4">
                  ...
                  {doctorData.education.map((edu, index) => (
                    <div key={index} className="education-item">
                      ...
                      <small className="text-muted">Graduated: {edu.year}</small>
                    </div>
                  ))}
                </div>
            ...
            <div className="reviews-header">
              <div className="rating-summary">
                <div className="average-rating">
                  ...
                  <p className="text-muted">Based on {doctorData.totalReviews} reviews</p>
                </div>
              </div>
            </div>
              ...
              <div className="doctor-header">
                ...
                <div className="doctor-info">
                  ...
                  <div className="doctor-meta">
                    ...
                    <div className="meta-item">
                      <Star size={16} />
                      <span>{doctorData.rating} ({doctorData.totalReviews} reviews)</span>
                    </div>
                    <div className="meta-item">
                      <Clock size={16} />
            ...
            <div className="booking-sidebar">
              <div className="booking-card">
                ...
                <div className="availability-section">
                  <div className="availability-status">
                    <div className={`status-indicator ${doctorData.availability.includes('Available') ? 'available' : 'unavailable'}`}></div>
              ...
              <div className="similar-doctors">
                ...
                <div className="similar-doctor-card">
                  <img src="https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=60&h=60&fit=crop&crop=face" alt="Similar Doctor" />
